...
//	driver.quit();
	...
	public Object[][] getData() {
		return new Object[][] { { "qaonkar4@mailinator.com", "Qa@123456", "ZARA COAT 3" },
				{ "qaonkar3@mailinator.com", "Qa@123456", "ADIDAS ORIGINAL" } };
	}
	...
	public Object[][] gethasmapData() throws IOException {
		...
		List<HashMap<String, String>> data = getJsonDataToMap(
				"D:\\Selenium2024\\SeleniumJavaFramework\\src\\test\\java\\qaOnkar\\data\\PurchaseOrder.json");
